 ...
 */
// define('FACEBOOK_SDK_V4_SRC_DIR', __DIR__ . '/includes/Facebook');
...
$redirectURL = 'http://localhost:8080/dressApp/homepage.php'; // Callback URL
...
if(isset($accessToken)){
    ...
    $query = "INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `my_closet`, `liked_outfits`, `account_permissions`) VALUES ('', '$username', '$femail', '$password', NULL, NULL, '$permissions')";
